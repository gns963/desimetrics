  ...
  // -------------------------------------------------------------- TNEB
  {
    ...
    translations: {
      hi: {
        ...
        aboutDiscom: [
          <>
            <strong>1957</strong> — तमिलनाडु इलेक्ट्रिसिटी बोर्ड (TNEB) एक
            एकल, वर्टिकली एकीकृत उपयोगिता के रूप में बना।
          </>,
          <>
            <strong>2010</strong> — इलेक्ट्रिसिटी एक्ट 2003 के तहत तीन
            संस्थाओं में पुनर्गठित: TNEB लिमिटेड (होल्डिंग कंपनी),
          ...
          <>
            <strong>2024</strong> — TANGEDCO के डिस्ट्रिब्यूशन बिज़नेस का
            नाम बदलकर तमिलनाडु पावर डिस्ट्रिब्यूशन कॉर्पोरेशन लिमिटेड
            (TNPDCL) कर दिया गया।
          </>,
          <>
            <strong>आज</strong> — &quot;TNEB&quot;, &quot;TANGEDCO&quot; और
            &quot;TNPDCL&quot; तीनों नाम आज भी बिलों, साइनेज और कस्टमर
            सर्विस पर एक साथ इस्तेमाल होते हैं।
          </>,
        ],
        coverageQA: {
      ...
      ta: {
        ...
        aboutDiscom: [
          <>
            <strong>1957</strong> — தமிழ்நாடு மின்சார வாரியம் (TNEB) ஒரு
            ஒற்றை, செங்குத்தாக ஒருங்கிணைந்த பயன்பாடாக உருவாக்கப்பட்டது.
          </>,
          <>
            <strong>2010</strong> — மின்சாரச் சட்டம் 2003-ன் கீழ் மூன்று
            நிறுவனங்களாக மறுசீரமைக்கப்பட்டது: TNEB லிமிடெட் (ஹோல்டிங்
            நிறுவனம்), தமிழ்நாடு உற்பத்தி மற்றும் விநியோக கழகம் லிமிடெட்
            (TANGEDCO) உற்பத்தி மற்றும் விநியோகத்திற்கு, மற்றும் தமிழ்நாடு
            பரிமாற்ற கழகம் லிமிடெட் (TANTRANSCO) பரிமாற்றத்திற்கு.
          </>,
          <>
            <strong>2024</strong> — TANGEDCO-வின் விநியோக வணிகம் தமிழ்நாடு
            மின் விநியோக கழகம் லிமிடெட் (TNPDCL) என மறுபெயரிடப்பட்டது.
          </>,
          <>
            <strong>இன்று</strong> — &quot;TNEB&quot;, &quot;TANGEDCO&quot;
            மற்றும் &quot;TNPDCL&quot; ஆகிய மூன்று பெயர்களும் பில்கள்,
            அடையாள பலகைகள் மற்றும் வாடிக்கையாளர் சேவையில் இன்றும்
            ஒன்றாகப் பயன்பாட்டில் உள்ளன.
          </>,
        ],
        coverageQA: {
  ...
  // -------------------------------------------------------------- MSEDCL
  {
    ...
    translations: {
      hi: {
        ...
        aboutDiscom: [
          <>
            <strong>2005</strong> — इलेक्ट्रिसिटी एक्ट 2003 के तहत महाराष्ट्र
            स्टेट इलेक्ट्रिसिटी बोर्ड (MSEB) को चार अलग कंपनियों में
            विभाजित किया गया: MSEB होल्डिंग कंपनी, महाराष्ट्र स्टेट पावर
            जनरेशन कं. (महाजेनको), महाराष्ट्र स्टेट इलेक्ट्रिसिटी
            ट्रांसमिशन कं. (महाट्रांसको), और महाराष्ट्र स्टेट इलेक्ट्रिसिटी
            डिस्ट्रिब्यूशन कं. लिमिटेड (MSEDCL) — जिसे आम तौर पर महावितरण
            या महाडिस्कॉम कहा जाता है — जो बिलिंग और डिस्ट्रिब्यूशन
            संभालती है।
          </>,
          <>
            <strong>कवरेज</strong> — MSEDCL लगभग पूरे महाराष्ट्र में बिजली
            वितरित करता है, लेकिन मुंबई शहर के ज़्यादातर हिस्से में नहीं:
            BEST, टाटा पावर और अदानी इलेक्ट्रिसिटी मुंबई के पास वहां
            डिस्ट्रिब्यूशन लाइसेंस हैं, जबकि MSEDCL मुंबई के कुछ उपनगर
            (जैसे मुलुंड और भांडुप) और बाकी राज्य को कवर करता है।
          </>,
        ],
        coverageQA: {
          q: 'क्या MSEDCL मुंबई को बिजली सप्लाई करता है?',
      ...
      mr: {
        ...
        aboutDiscom: [
          <>
            <strong>2005</strong> — इलेक्ट्रिसिटी अॅक्ट 2003 अंतर्गत
            महाराष्ट्र स्टेट इलेक्ट्रिसिटी बोर्ड (MSEB) चे चार वेगळ्या
            कंपन्यांमध्ये विभाजन करण्यात आले: MSEB होल्डिंग कंपनी,
            महाराष्ट्र स्टेट पॉवर जनरेशन कं. (महाजेनको), महाराष्ट्र
            स्टेट इलेक्ट्रिसिटी ट्रान्समिशन कं. (महाट्रान्सको), आणि
            महाराष्ट्र स्टेट इलेक्ट्रिसिटी डिस्ट्रिब्युशन कं. लिमिटेड
            (MSEDCL) — ज्याला सामान्यतः महावितरण किंवा महाडिस्कॉम
            म्हणतात — जी बिलिंग आणि वितरण सांभाळते.
          </>,
          <>
            <strong>कव्हरेज</strong> — MSEDCL जवळजवळ संपूर्ण महाराष्ट्रात
            वीज वितरित करते, पण मुंबई शहराच्या बहुतांश भागात नाही: BEST,
            टाटा पॉवर आणि अदानी इलेक्ट्रिसिटी मुंबई यांच्याकडे तिथे
            वितरण परवाने आहेत, तर MSEDCL मुंबईचे काही उपनगर (जसे मुलुंड
            आणि भांडुप) आणि उर्वरित राज्य कव्हर करते.
          </>,
        ],
        coverageQA: {
          q: 'MSEDCL मुंबईला वीज पुरवते का?',
  ...
  // -------------------------------------------------------------- BESCOM
  {
    ...
    translations: {
      hi: {
        ...
        aboutDiscom: [
          <>
            <strong>2002</strong> — BESCOM (बैंगलोर इलेक्ट्रिसिटी सप्लाई
            कंपनी लिमिटेड) 1 जून 2002 को बनी, जब कर्नाटक पावर ट्रांसमिशन
            कॉर्पोरेशन लिमिटेड (KPTCL) के डिस्ट्रिब्यूशन बिज़नेस को पांच
            क्षेत्रीय कंपनियों में बांटा गया — BESCOM, MESCOM, HESCOM,
            GESCOM और CESC — जबकि KPTCL ने ट्रांसमिशन अपने पास रखा।
          </>,
          <>
            <strong>कवरेज</strong> — BESCOM का क्षेत्र बैंगलोर अर्बन और
            बैंगलोर रूरल ज़िलों के साथ छह पड़ोसी ज़िलों (चिक्काबल्लापुरा,
            कोलार, दावणगेरे, तुमकुर, चित्रदुर्ग और रामनगर) को कवर करता
            है — सिर्फ बैंगलोर शहर से बड़ा क्षेत्र।
          </>,
        ],
        coverageQA: {
      ...
      kn: {
        ...
        aboutDiscom: [
          <>
            <strong>2002</strong> — BESCOM (ಬೆಂಗಳೂರು ಎಲೆಕ್ಟ್ರಿಸಿಟಿ ಸಪ್ಲೈ
            ಕಂಪನಿ ಲಿಮಿಟೆಡ್) 1 ಜೂನ್ 2002 ರಂದು ರೂಪುಗೊಂಡಿತು, ಕರ್ನಾಟಕ ಪವರ್
            ಟ್ರಾನ್ಸ್‌ಮಿಷನ್ ಕಾರ್ಪೊರೇಷನ್ ಲಿಮಿಟೆಡ್ (KPTCL) ನ ವಿತರಣಾ
            ವ್ಯವಹಾರವನ್ನು ಐದು ಪ್ರಾದೇಶಿಕ ಕಂಪನಿಗಳಾಗಿ — BESCOM, MESCOM,
            HESCOM, GESCOM ಮತ್ತು CESC — ವಿಭಜಿಸಿದಾಗ, KPTCL ಟ್ರಾನ್ಸ್‌ಮಿಷನ್
            ಅನ್ನು ಉಳಿಸಿಕೊಂಡಿತು.
          </>,
          <>
            <strong>ವ್ಯಾಪ್ತಿ</strong> — BESCOM ನ ಪ್ರದೇಶ ಬೆಂಗಳೂರು ನಗರ
            ಮತ್ತು ಬೆಂಗಳೂರು ಗ್ರಾಮಾಂತರ ಜಿಲ್ಲೆಗಳ ಜೊತೆಗೆ ಆರು ನೆರೆಯ
            ಜಿಲ್ಲೆಗಳನ್ನು (ಚಿಕ್ಕಬಳ್ಳಾಪುರ, ಕೋಲಾರ, ದಾವಣಗೆರೆ, ತುಮಕೂರು,
            ಚಿತ್ರದುರ್ಗ ಮತ್ತು ರಾಮನಗರ) ಒಳಗೊಂಡಿದೆ — ಬೆಂಗಳೂರು ನಗರಕ್ಕಿಂತ
            ವಿಶಾಲ ಪ್ರದೇಶ.
          </>,
        ],
        coverageQA: {
  ...
  // -------------------------------------------------------------- KSEB
  {
    ...
    translations: {
      hi: {
        ...
        aboutDiscom: [
          <>
            <strong>1957</strong> — केरल राज्य विद्युत बोर्ड (KSEB) ने 31
            मार्च 1957 को काम करना शुरू किया।
          </>,
          <>
            <strong>2011–2013</strong> — इलेक्ट्रिसिटी एक्ट 2003 के तहत,
            इसे एक कंपनी — केरल राज्य विद्युत बोर्ड लिमिटेड (KSEBL) — में
            बदला गया, जो 14 जनवरी 2011 को स्थापित हुई और 1 नवंबर 2013 से
            स्वतंत्र रूप से कार्यरत है।
          </>,
          <>
            <strong>आज</strong> — बिलों और ग्राहक सेवा के लिए
            &quot;KSEB&quot; ही सबसे ज़्यादा इस्तेमाल होने वाला नाम बना
            हुआ है।
          </>,
          <>
            <strong>कवरेज</strong> — KSEB लगभग पूरे केरल में बिजली वितरित
            करता है, कुछ अपवादों के साथ: त्रिशूर म्युनिसिपल कॉर्पोरेशन
            क्षेत्र, मुन्नार (कन्नन देवन हिल्स) क्षेत्र, और कई छोटे
            औद्योगिक-पार्क ज़ोन अलग, छोटे लाइसेंसधारियों द्वारा सर्व किए
            जाते हैं।
          </>,
        ],
        coverageQA: {
      ...
      ml: {
        ...
        aboutDiscom: [
          <>
            <strong>1957</strong> — കേരള സ്റ്റേറ്റ് ഇലക്ട്രിസിറ്റി ബോർഡ്
            (KSEB) 1957 മാർച്ച് 31-ന് പ്രവർത്തനം ആരംഭിച്ചു.
          </>,
          <>
            <strong>2011–2013</strong> — ഇലക്ട്രിസിറ്റി ആക്ട് 2003
            പ്രകാരം, ഇത് ഒരു കമ്പനിയായി മാറ്റി — കേരള സ്റ്റേറ്റ്
            ഇലക്ട്രിസിറ്റി ബോർഡ് ലിമിറ്റഡ് (KSEBL) — 2011 ജനുവരി 14-ന്
            രജിസ്റ്റർ ചെയ്യുകയും 2013 നവംബർ 1 മുതൽ സ്വതന്ത്രമായി
            പ്രവർത്തിക്കുകയും ചെയ്തു.
          </>,
          <>
            <strong>ഇന്ന്</strong> — ബില്ലുകൾക്കും ഉപഭോക്തൃ സേവനത്തിനും
            ഏറ്റവും കൂടുതൽ ഉപയോഗിക്കുന്ന പേര് &quot;KSEB&quot; ആണ്.
          </>,
          <>
            <strong>പരിധി</strong> — KSEB കേരളത്തിന്റെ മിക്കവാറും
            എല്ലായിടത്തും വൈദ്യുതി വിതരണം ചെയ്യുന്നു, ചില
            അപവാദങ്ങളോടെ: തൃശൂർ മുനിസിപ്പൽ കോർപ്പറേഷൻ പ്രദേശം, മൂന്നാർ
            (കണ്ണൻ ദേവൻ ഹിൽസ്) പ്രദേശം, കൂടാതെ നിരവധി ചെറിയ
            വ്യാവസായിക-പാർക്ക് മേഖലകളും പ്രത്യേക, ചെറിയ ലൈസൻസികൾ
            സേവിക്കുന്നു.
          </>,
        ],
        coverageQA: {
  ...
  // -------------------------------------------------------------- WBSEDCL
  {
    ...
    translations: {
      hi: {
        ...
        aboutDiscom: [
          <>
            <strong>1955</strong> — पश्चिम बंगाल राज्य विद्युत बोर्ड
            (WBSEB) का गठन हुआ।
          </>,
          <>
            <strong>2007</strong> — राज्य की पावर रिफॉर्म स्कीम के तहत, इसे
            1 अप्रैल 2007 को पश्चिम बंगाल राज्य विद्युत वितरण कंपनी
            लिमिटेड (WBSEDCL) (वितरण के लिए) और पश्चिम बंगाल राज्य विद्युत
            ट्रांसमिशन कंपनी लिमिटेड (WBSETCL) (ट्रांसमिशन के लिए) में
            विभाजित किया गया।
          </>,
          <>
            <strong>कवरेज</strong> — WBSEDCL ज़्यादातर पश्चिम बंगाल में
            बिजली वितरित करता है, लेकिन कोलकाता में नहीं: शहर, हावड़ा और
            उत्तर/दक्षिण 24 परगना तथा हुगली के कुछ हिस्से CESC लिमिटेड
            द्वारा सर्व किए जाते हैं, जो अपनी अलग टैरिफ वाली एक पुरानी
            निजी वितरण लाइसेंसधारी कंपनी है।
          </>,
        ],
        coverageQA: {
      ...
      bn: {
        ...
        aboutDiscom: [
          <>
            <strong>১৯৫৫</strong> — পশ্চিমবঙ্গ রাজ্য বিদ্যুৎ বোর্ড (WBSEB)
            গঠিত হয়েছিল।
          </>,
          <>
            <strong>২০০৭</strong> — রাজ্যের পাওয়ার রিফর্ম স্কিমের অধীনে,
            এটি ১ এপ্রিল ২০০৭-এ পশ্চিমবঙ্গ রাজ্য বিদ্যুৎ বিতরণ কোম্পানি
            লিমিটেড (WBSEDCL) (বিতরণের জন্য) এবং পশ্চিমবঙ্গ রাজ্য বিদ্যুৎ
            ট্রান্সমিশন কোম্পানি লিমিটেড (WBSETCL) (ট্রান্সমিশনের জন্য)
            বিভক্ত হয়েছিল।
          </>,
          <>
            <strong>পরিসীমা</strong> — WBSEDCL বেশিরভাগ পশ্চিমবঙ্গে
            বিদ্যুৎ বিতরণ করে, কিন্তু কলকাতায় নয়: শহর, হাওড়া এবং
            উত্তর/দক্ষিণ ২৪ পরগনা ও হুগলির কিছু অংশ CESC লিমিটেড দ্বারা
            পরিষেবা পায়, যা তার নিজস্ব পৃথক ট্যারিফ সহ একটি দীর্ঘস্থায়ী
            বেসরকারি বিতরণ লাইসেন্সপ্রাপ্ত সংস্থা।
          </>,
        ],
        coverageQA: {
  ...
  },
  {
    ...
    translations: {
      hi: {
        ...
        aboutDiscom: [
          <>
            <strong>2003–2005</strong> — गुजरात इलेक्ट्रिसिटी बोर्ड (GEB)
            को एक जनरेशन कंपनी (GSECL), एक ट्रांसमिशन कंपनी (GETCO), और एक
            होल्डिंग कंपनी, गुजरात ऊर्जा विकास निगम लिमिटेड (GUVNL) के तहत
            चार डिस्ट्रिब्यूशन कंपनियों में पुनर्गठित किया गया। मध्य
            गुजरात विज कंपनी लिमिटेड (MGVCL) को 15 सितंबर 2003 को स्थापित
            किया गया और यह 1 अप्रैल 2005 से कार्यशील हुई।
          </>,
          <>
            <strong>कवरेज</strong> — MGVCL वडोदरा और मध्य गुजरात के 12
            ज़िलों को सर्व करता है। बाकी तीन डिस्ट्रिब्यूशन कंपनियां —
            UGVCL (उत्तर गुजरात, अहमदाबाद सहित), PGVCL (सौराष्ट्र) और
            DGVCL (दक्षिण गुजरात, सूरत सहित) — बाकी राज्य को कवर करती हैं।
          </>,
        ],
        coverageQA: {
      ...
      gu: {
        ...
        aboutDiscom: [
          <>
            <strong>2003–2005</strong> — ગુજરાત ઇલેક્ટ્રિસિટી બોર્ડ (GEB)ને
            એક જનરેશન કંપની (GSECL), એક ટ્રાન્સમિશન કંપની (GETCO), અને એક
            હોલ્ડિંગ કંપની, ગુજરાત ઊર્જા વિકાસ નિગમ લિમિટેડ (GUVNL) હેઠળ
            ચાર ડિસ્ટ્રિબ્યુશન કંપનીઓમાં પુનર્ગઠિત કરવામાં આવ્યું. મધ્ય
            ગુજરાત વીજ કંપની લિમિટેડ (MGVCL) ની સ્થાપના 15 સપ્ટેમ્બર
            2003ના રોજ થઈ અને તે 1 એપ્રિલ 2005થી કાર્યરત થઈ.
          </>,
          <>
            <strong>કવરેજ</strong> — MGVCL વડોદરા અને મધ્ય ગુજરાતના 12
            જિલ્લાઓને સેવા આપે છે. બાકીની ત્રણ ડિસ્ટ્રિબ્યુશન કંપનીઓ —
            UGVCL (ઉત્તર ગુજરાત, અમદાવાદ સહિત), PGVCL (સૌરાષ્ટ્ર) અને
            DGVCL (દક્ષિણ ગુજરાત, સુરત સહિત) — બાકીના રાજ્યને આવરી લે છે.
          </>,
        ],
        coverageQA: {
  ...
  },
  {
    ...
    translations: {
      hi: {
        ...
        aboutDiscom: [
          <>
            <strong>2 जून 2014</strong> — जब आंध्र प्रदेश राज्य को आंध्र
            प्रदेश पुनर्गठन अधिनियम, 2014 के तहत विभाजित किया गया, तो नए
            बने तेलंगाना को सर्व करने वाले डिस्ट्रिब्यूशन बिज़नेस को दो
            कंपनियों में पुनर्गठित किया गया: तेलंगाना स्टेट सदर्न पावर
            डिस्ट्रिब्यूशन कंपनी लिमिटेड (TGSPDCL, जिसे TSSPDCL भी कहते
            हैं) और तेलंगाना स्टेट नॉर्दर्न पावर डिस्ट्रिब्यूशन कंपनी
            लिमिटेड (TGNPDCL)।
          </>,
          <>
            <strong>आज</strong> — TGSPDCL हैदराबाद और 14 अन्य दक्षिणी
            ज़िलों (रंगारेड्डी, मेडचल, नलगोंडा और महबूबनगर सहित) को कवर
            करती है, लगभग 1.11 करोड़ उपभोक्ताओं को सर्व करती है। TGNPDCL
            हनुमाकोंडा से 18 उत्तरी ज़िलों को कवर करती है।
          </>,
        ],
        coverageQA: {
      ...
      te: {
        ...
        aboutDiscom: [
          <>
            <strong>2 జూన్ 2014</strong> — ఆంధ్రప్రదేశ్ రాష్ట్రాన్ని
            ఆంధ్రప్రదేశ్ పునర్వ్యవస్థీకరణ చట్టం, 2014 కింద
            విభజించినప్పుడు, కొత్తగా ఏర్పడిన తెలంగాణకు సేవలందించే
            డిస్ట్రిబ్యూషన్ వ్యాపారం రెండు కంపెనీలుగా
            పునర్వ్యవస్థీకరించబడింది: తెలంగాణ స్టేట్ సదరన్ పవర్
            డిస్ట్రిబ్యూషన్ కంపెనీ లిమిటెడ్ (TGSPDCL, దీనిని TSSPDCL అని
            కూడా అంటారు) మరియు తెలంగాణ స్టేట్ నార్తర్న్ పవర్
            డిస్ట్రిబ్యూషన్ కంపెనీ లిమిటెడ్ (TGNPDCL).
          </>,
          <>
            <strong>ఈరోజు</strong> — TGSPDCL హైదరాబాద్ మరియు 14 ఇతర దక్షిణ
            జిల్లాలను (రంగారెడ్డి, మేడ్చల్, నల్గొండ మరియు
            మహబూబ్‌నగర్‌తో సహా) కవర్ చేస్తుంది, సుమారు 1.11 కోట్ల
            వినియోగదారులకు సేవలందిస్తుంది. TGNPDCL హనుమకొండ నుండి 18
            ఉత్తర జిల్లాలను కవర్ చేస్తుంది.
          </>,
        ],
        coverageQA: {
  ...
  },
  {
    ...
    translations: {
      hi: {
        ...
        aboutDiscom: [
          <>
            <strong>1 अप्रैल 2000</strong> — साउदर्न पावर डिस्ट्रिब्यूशन
            कंपनी ऑफ AP लिमिटेड (APSPDCL) को कृष्णा, गुंटूर, प्रकाशम,
            नेल्लोर, चित्तूर और कडपा ज़िलों में बिजली वितरित करने के लिए
            शामिल किया गया था, इसका मुख्यालय तिरुपति में है।
          </>,
          <>
            <strong>2 जून 2014</strong> — जब आंध्र प्रदेश को विभाजित कर
            तेलंगाना बनाया गया, तो अनंतपुर और कुरनूल ज़िले APSPDCL के
            क्षेत्र में जोड़े गए।
          </>,
          <>
            <strong>आज</strong> — तटीय-उत्तर आंध्र प्रदेश, जिसमें
            विशाखापत्तनम शामिल है, को एक अलग कंपनी, APEPDCL (ईस्टर्न पावर
            डिस्ट्रिब्यूशन कंपनी) सर्व करती है।
          </>,
        ],
        coverageQA: {
      ...
      te: {
        ...
        aboutDiscom: [
          <>
            <strong>1 ఏప్రిల్ 2000</strong> — సదరన్ పవర్ డిస్ట్రిబ్యూషన్
            కంపెనీ ఆఫ్ AP లిమిటెడ్ (APSPDCL) కృష్ణా, గుంటూరు, ప్రకాశం,
            నెల్లూరు, చిత్తూరు మరియు కడప జిల్లాల్లో విద్యుత్‌ను పంపిణీ
            చేయడానికి స్థాపించబడింది, దీని ప్రధాన కార్యాలయం తిరుపతిలో
            ఉంది.
          </>,
          <>
            <strong>2 జూన్ 2014</strong> — ఆంధ్రప్రదేశ్‌ను విభజించి
            తెలంగాణను సృష్టించినప్పుడు, అనంతపురం మరియు కర్నూలు జిల్లాలు
            APSPDCL భూభాగానికి జోడించబడ్డాయి.
          </>,
          <>
            <strong>ఈరోజు</strong> — విశాఖపట్నంతో సహా తీర-ఉత్తర
            ఆంధ్రప్రదేశ్‌కు ఒక ప్రత్యేక కంపెనీ, APEPDCL (ఈస్టర్న్ పవర్
            డిస్ట్రిబ్యూషన్ కంపెనీ) సేవలందిస్తుంది.
          </>,
        ],
        coverageQA: {
