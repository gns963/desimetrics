...
const TRANSLATED: Record<NonEnglishLocale, TranslatedRoutes> = {
  hi: {
    exact: new Set([
      ...
      '/blog/wbsedcl-complete-guide-electricity-bill',
      '/blog/kseb-complete-guide-electricity-bill',
      '/blog/jvvnl-complete-guide-electricity-bill',
      '/blog/pspcl-complete-guide-electricity-bill',
      '/blog/tsspdcl-complete-guide-electricity-bill',
      '/contact',
      '/cookie-policy',
      '/data-sources',
      '/disclaimer',
